...
namespace TestingLocalDatabase.MyLocalDBDataSetTableAdapters {
    ...
    public partial class TestTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TestTable] SET [name] = @name WHERE (([Id] = @Original_Id) AND ((@I" +
                "sNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)));\r\nSELECT Id, n" +
                "ame FROM TestTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestingLocalDatabase.Properties.Settings.Default.MyLocalDBConnectionString;
        }
        ...
        public virtual int Fill(MyLocalDBDataSet.TestTableDataTable dataTable) {
        ...
        public virtual MyLocalDBDataSet.TestTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyLocalDBDataSet.TestTableDataTable dataTable = new MyLocalDBDataSet.TestTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyLocalDBDataSet.TestTableDataTable dataTable) {
